...
public class ScreeningLocators {
    ...
    public static final By ageVerificationDOB = By.xpath("//input[@class='hasDatepicker']");
    ...
    public static final By longTermUnemp_Benefit_Start_Date = By.xpath("//input[@class='hasDatepicker']");
